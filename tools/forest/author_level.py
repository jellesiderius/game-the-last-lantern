...
ext('StartAnchor','Script','scripts/world/checkpoint_anchor.gd')
ext('StartArea','Resource','settings/areas/forest_opening.tres')
...
node('StartCheckpoint','Marker3D',props='position = Vector3(-3,0,7.4)\nscript = ExtResource("StartAnchor")\ncheckpoint_id = &"start.forest_stump"\narea = ExtResource("StartArea")')
