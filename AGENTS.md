...
- PC controls: WASD; LMB/V/J melee; MMB/B/K heavy; Q or RMB hold to draw, release to fire; Space dodge; F lock-on, Z/X or wheel switch target. PlayStation: LS move/aim, RS bounded camera look (while locked: RS flick switches target, R3 toggles lock), square melee, R2 heavy, cross dodge, triangle interact, L2 aim + circle draw/release, D-pad ranged slot, Options/touchpad menu. Menu: cross confirm, circle back, L1/R1 tabs.
